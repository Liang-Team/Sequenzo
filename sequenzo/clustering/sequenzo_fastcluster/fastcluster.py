# -*- coding: utf-8 -*-
__doc__ = """Optimized fast hierarchical clustering routines with SIMD and parallelization

This is an optimized version of fastcluster with the following enhancements:
- SIMD vectorization (AVX2, SSE2, ARM NEON)
- OpenMP parallelization
- Memory access optimization
- Advanced compiler optimizations

Original fastcluster:
Copyright:
