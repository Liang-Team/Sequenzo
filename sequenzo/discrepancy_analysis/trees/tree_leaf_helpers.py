...
def get_leaf_membership(
    ...
    **Corresponds to TraMineR function: `disstreeleaf()`**
    ...
    ----------
    tree : dict
        Tree object returned by distance_tree() or sequence_tree()
    ...
    Examples
    --------
    >>> from sequenzo.discrepancy_analysis import distance_tree, get_leaf_membership
    >>> 
    >>> # Build tree (example)
    >>> tree = distance_tree(...)
    >>> 
...
def get_classification_rules(
    ...
    **Corresponds to TraMineR function: `disstree.get.rules()`**
    ...
    Examples
    --------
    >>> from sequenzo.discrepancy_analysis import sequence_tree, get_classification_rules
    >>> 
    >>> # Build tree
    >>> tree = sequence_tree(...)
    >>> 
