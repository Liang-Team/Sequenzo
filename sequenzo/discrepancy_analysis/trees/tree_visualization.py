...
def plot_tree(
    ...
    **Corresponds to TraMineR function: `plot.disstree()` and `plot.seqtree()`**
    ...
    ----------
    tree : dict
        Tree object from distance_tree() or sequence_tree()
    ...
    Examples
    --------
    >>> from sequenzo.discrepancy_analysis import distance_tree, plot_tree
    >>> 
    >>> # Build tree
    >>> tree = distance_tree(...)
    >>> 
...
def print_tree(
    ...
    **Corresponds to TraMineR function: `print.disstree()` and `print.seqtree()`**
    ...
    Examples
    --------
    >>> from sequenzo.discrepancy_analysis import distance_tree, print_tree
    >>> 
    >>> tree = distance_tree(...)
    >>> print_tree(tree)
    """
...
def export_tree_to_dot(
    ...
    **Corresponds to TraMineR function: `disstree2dot()` and `seqtree2dot()`**
    ...
    Examples
    --------
    >>> from sequenzo.discrepancy_analysis import distance_tree, export_tree_to_dot
    >>> 
    >>> tree = distance_tree(...)
