...
@Desc    : Computes pairwise dissimilarities between sequences or dissimilarity from a reference sequence.
        ...
        :params
            ...
            method         : String.The dissimilarity measure to use.
                            It can be "OM", "OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMtspell", "OMstran", "HAM", "DHD",
            ...
            norm           : Default: "none". The normalization to use when method is one of
                            {"OM", "OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMstran", "TWED", "HAM", "DHD",
            ...
            indel          : Insertion/deletion  cost(s).
                            ...
                            "OMspellUnitFree", "OMtspell", "OMstran", or "TWED".
            ...
            sm             : Substitution costs. Default: NULL.
                            (1)The substitution-cost matrix when a matrix
                                and method is one of "OM", "OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMstran", "HAM", or "TWED".
                            ...
                            sm is mandatory when method is one of "OM", "OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMstran", or "TWED".
...
def get_distance_matrix(seqdata=None, method=None, refseq=None, norm="none", indel="auto", sm=None, full_matrix=True,
    ...
    # check method
    om_methods = ["OM", "OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMstran", "OMtspell"]
    ...
    if norm != "none" and method not in ["OM", "OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMtspell", "OMstran", "TWED", "HAM", "DHD", "CHI2", "EUCLID", "LCS", "LCP", "RLCP", "LCPspell", "RLCPspell", "LCPmst", "RLCPmst", "LCPprod", "RLCPprod", "NMS", "NMSMST", "SVRspell"]:
    ...
    # 3. OMspell, OMspellUnitFree, OMtspell, LCPspell, RLCPspell
    if method in ["OMspell", "OMspellUnitFree", "OMtspell"] and expcost < 0:
    ...
    if norm == "auto":
        if method in ["OM", "HAM", "DHD"]:
            ...
            norm = "maxdist"
        elif method in ["OMloc", "OMslen", "OMspell", "OMspellUnitFree", "OMtspell", "OMstran", "TWED"]:
            norm = "YujianBo"
    ...
    seq_or_spell = "spell sequences" if method in ["OMspell", "OMspellUnitFree", "OMtspell", "LCPspell", "RLCPspell"] else "sequences"
    ...
    if refseq_type != "none":
        ...
        if method == "OM":
            ...
            om = c_code.OMspellUnitFreeDistance(dseqs_num,
                                            sm,
                                            indel,
                                            norm_num,
                                            refseq_id,
