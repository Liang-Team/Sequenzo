...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    "get_spell_survival_analysis": (
        "sequenzo.with_event_history_analysis",
        "get_spell_survival_analysis",
    ),
    ...
    "get_initial_probs": ("sequenzo.seqhmm", "get_initial_probs"),
    "get_transition_probs": ("sequenzo.seqhmm", "get_transition_probs"),
    "get_emission_probs": ("sequenzo.seqhmm", "get_emission_probs"),
    "hidden_paths": ("sequenzo.seqhmm", "hidden_paths"),
    "permute_states": ("sequenzo.seqhmm", "permute_states"),
    "trim_model": ("sequenzo.seqhmm", "trim_model"),
    "separate_mhmm": ("sequenzo.seqhmm", "separate_mhmm"),
    "data_to_stslist": ("sequenzo.seqhmm", "data_to_stslist"),
    "stslist_to_data": ("sequenzo.seqhmm", "stslist_to_data"),
    "stacked_sequence_plot": ("sequenzo.seqhmm", "stacked_sequence_plot"),
    "ssplot": ("sequenzo.seqhmm", "ssplot"),
    "gridplot": ("sequenzo.seqhmm", "gridplot"),
    ...
    # hierarchical (relational / hierarchical sequence analysis)
    "run_hierarchical_sequence_analysis": ("sequenzo.hierarchical", "run_hierarchical_sequence_analysis"),
    "HierarchicalSequenceResult": ("sequenzo.hierarchical", "HierarchicalSequenceResult"),
    "RelationalSequenceData": ("sequenzo.hierarchical", "RelationalSequenceData"),
    "RelationalDistanceMatrix": ("sequenzo.hierarchical", "RelationalDistanceMatrix"),
    "validate_relational_sequence_data": ("sequenzo.hierarchical", "validate_relational_sequence_data"),
    "make_relational_sequences": ("sequenzo.hierarchical", "make_relational_sequences"),
    "compute_relational_distance_matrix": ("sequenzo.hierarchical", "compute_relational_distance_matrix"),
    "summarize_distance_by_structure": ("sequenzo.hierarchical", "summarize_distance_by_structure"),
    "hierarchical_sequence_discrepancy": ("sequenzo.hierarchical", "hierarchical_sequence_discrepancy"),
    "permutation_test_level_effect": ("sequenzo.hierarchical", "permutation_test_level_effect"),
    "crossed_sequence_discrepancy": ("sequenzo.hierarchical", "crossed_sequence_discrepancy"),
    "CrossedDecompositionResult": ("sequenzo.hierarchical", "CrossedDecompositionResult"),
    "permutation_test_crossed_effect": ("sequenzo.hierarchical", "permutation_test_crossed_effect"),
    "compute_pair_residuals": ("sequenzo.hierarchical", "compute_pair_residuals"),
    "cluster_pair_sequences": ("sequenzo.hierarchical", "cluster_pair_sequences"),
    "cluster_level_1_profiles": ("sequenzo.hierarchical", "cluster_level_1_profiles"),
    "cluster_level_2_profiles": ("sequenzo.hierarchical", "cluster_level_2_profiles"),
    "HierarchicalClusterResult": ("sequenzo.hierarchical", "HierarchicalClusterResult"),
    "additive_sequence_discrepancy": ("sequenzo.hierarchical", "additive_sequence_discrepancy"),
    "sample_pairwise_distances": ("sequenzo.hierarchical", "sample_pairwise_distances"),
