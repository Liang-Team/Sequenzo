...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    # sequence_operations
    "seqconc": ("sequenzo.sequence_operations", "seqconc"),
    "seqdecomp": ("sequenzo.sequence_operations", "seqdecomp"),
    "seqsep": ("sequenzo.sequence_operations", "seqsep"),
    "seqrecode": ("sequenzo.sequence_operations", "seqrecode"),
    "seqshift": ("sequenzo.sequence_operations", "seqshift"),
    "seqasnum": ("sequenzo.sequence_operations", "seqasnum"),
    # compare_differences
    ...
    "create_event_sequences": ("sequenzo.event_sequences", "create_event_sequences"),
    ...
    "plot_event_sequences": ("sequenzo.event_sequences", "plot_event_sequences"),
    ...
    "is_eseq": ("sequenzo.event_sequences", "is_eseq"),
    "is_seqelist": ("sequenzo.event_sequences", "is_seqelist"),
    "seqelength": ("sequenzo.event_sequences", "seqelength"),
    "seqeweight": ("sequenzo.event_sequences", "seqeweight"),
