---
title: "Discrepancy Analysis Tutorial: Understanding Sequence Patterns with Regression Trees"
...
Welcome to the **Discrepancy Analysis** tutorial using **TraMineR (R)**! 🌳
...
cat("✅ TraMineR loaded successfully!\n")
...
cat("Pseudo R²:", assoc_result$stat["Pseudo R2", "t0"], "\n")
cat("P-value:", assoc_result$stat["Pseudo F", "p.value"], "\n")
cat("\nInterpretation:\n")
cat("- Pseudo R²:", round(assoc_result$stat["Pseudo R2", "t0"] * 100, 1), 
...
cat("✅ Sequence tree built successfully!\n")
cat("\nTree structure:\n")
...
cat("Global R²:", seqtree_result$info$R2, "\n")
```
...
cat("✅ Sequence tree visualization created!\n")
```
...
cat("✅ Distance tree visualization created!\n")
```
...
cat("✅ DOT file created: tree_analysis_lsog_seqtree.dot\n")
...
cat("✅ DOT file created: tree_analysis_lsog_disstree.dot\n")
...
Congratulations! 🎉 You've learned how to use TraMineR to:

1. ✅ Compute pseudo-variance to measure sequence diversity (`dissvar`)
2. ✅ Test associations between groups and sequence patterns (`dissassoc`)
3. ✅ Build regression trees from distance matrices and sequence data (`disstree`, `seqtree`)
4. ✅ Extract leaf memberships and classification rules (`disstreeleaf`, `disstree.get.rules`)
5. ✅ Visualize trees using text and plots (`print`, `plot`)
