...
实现：fastcluster、scipy、sklearn、Sequenzo（含 linkage / X_features）
...
# =============================================================================
def ward_labels_sequenzo_xfeatures(X_features, num_clusters, entity_ids=None, ward_variant="ward_d2"):
    """
