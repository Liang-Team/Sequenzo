...
# Usage: Rscript tests/discrepancy_analysis/traminer_reference.R
...
), "tests/discrepancy_analysis/ref_dissvar.csv", row.names = FALSE)
...
), "tests/discrepancy_analysis/ref_dissassoc.csv", row.names = FALSE)
...
write.csv(tree_info, "tests/discrepancy_analysis/ref_disstree_info.csv", row.names = FALSE)

# Save leaf memberships
write.csv(data.frame(leaf_id = leaf_ids), 
          "tests/discrepancy_analysis/ref_disstree_leaves.csv", row.names = FALSE)
...
write.csv(data.frame(
    ...
    rule = rules
), "tests/discrepancy_analysis/ref_disstree_rules.csv", row.names = FALSE)
...
write.csv(data.frame(leaf_id = seqtree_leaf_ids),
          "tests/discrepancy_analysis/ref_seqtree_leaves.csv", row.names = FALSE)
...
write.csv(data.frame(
    ...
    rule = seqtree_rules
), "tests/discrepancy_analysis/ref_seqtree_rules.csv", row.names = FALSE)
...
write.csv(indic,
          "tests/discrepancy_analysis/ref_dissindic.csv",
          row.names = FALSE)

cat("\n=== Reference generation complete ===\n")
cat("Reference files saved to tests/discrepancy_analysis/\n")
cat("Generated files:\n")
cat("  - ref_dissvar.csv\n")
