...
**What is tested:**
- `overall_discrepancy()` vs TraMineR's `dissvar()`: Exact variance values
- `single_factor_association()` vs TraMineR's `dissassoc()`: Pseudo F, R², p-values
- `distance_tree()` vs TraMineR's `disstree()`: Tree structure and leaf counts
- `sequence_tree()` vs TraMineR's `seqtree()`: Sequence tree structure
...
- `test_discrepancy_analysis_lsog.py`: Functional tests that don't require reference files
"""
...
from sequenzo.discrepancy_analysis.stats.individual_indicators import individual_indicators
...
# ============================================================================
# Test overall_discrepancy vs TraMineR dissvar
# ============================================================================

def test_dissvar_unweighted_consistency(lsog_distance_matrix):
    """Compare overall_discrepancy (unweighted) with TraMineR dissvar."""
...
def test_dissvar_weighted_consistency(lsog_distance_matrix):
    """Compare overall_discrepancy (weighted) with TraMineR dissvar."""
    ref = _load_reference_file("ref_dissvar.csv")
    if ref is None:
        pytest.skip("Reference file not found. Run traminer_reference.R first.")
    ...
    variance = overall_discrepancy(lsog_distance_matrix, weights=weights, squared=False)
...
def test_dissvar_squared_consistency(lsog_distance_matrix):
    """Compare overall_discrepancy (squared) with TraMineR dissvar."""
    ref = _load_reference_file("ref_dissvar.csv")
    if ref is None:
        pytest.skip("Reference file not found. Run traminer_reference.R first.")
    
    variance = overall_discrepancy(lsog_distance_matrix, weights=None, squared=True)
...
# ============================================================================
# Test single_factor_association vs TraMineR dissassoc
# ============================================================================

def test_dissassoc_consistency(lsog_distance_matrix, lsog_predictors):
    """Compare single_factor_association with TraMineR dissassoc."""
...
# ============================================================================
# Test individual_indicators vs TraMineR dissindic
# ============================================================================

def test_dissindic_consistency(lsog_distance_matrix, lsog_predictors):
    """Compare individual_indicators with TraMineRextras dissindic."""
...
# ============================================================================
# Test distance_tree vs TraMineR disstree
# ============================================================================

def test_disstree_structure_consistency(lsog_distance_matrix, lsog_predictors):
    """Compare distance_tree structure with TraMineR disstree."""
...
# ============================================================================
# Test sequence_tree vs TraMineR seqtree
# ============================================================================

def test_seqtree_structure_consistency(lsog_seqdata, lsog_predictors):
    """Compare sequence_tree structure with TraMineR seqtree."""
...
# ============================================================================
# Test single_factor_association permutation test p-values
# ============================================================================
